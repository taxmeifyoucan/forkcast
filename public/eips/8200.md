...
[EIP-7666](./eip-7666.md) demonstrates this approach with the identity precompile. This EIP extends the same technique to three additional precompiles that either see limited use or can be evmified with a small cost:
