...
The [full proposal report](../assets/eip-7904/analysis/2026-06-10/new_gas_proposal.md), including per-client breakdowns and worst-case provenance, accompanies this EIP. A live, regenerated version of the analysis, together with the benchmark and estimation pipeline that produced it, is maintained in a public repository linked from the discussions-to thread.
