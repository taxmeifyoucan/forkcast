...
- **Relevance**: The mascot **MUST** relate thematically to one or more of the network upgrade's headliners, the namesakes of the network upgrade's layer names (e.g., the execution layer city or the consensus layer star), or the client interop events for the network upgrade.
