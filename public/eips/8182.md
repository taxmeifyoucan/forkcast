...
In a hardware-wallet flow, the hardware wallet signs only the auth circuit's intent authorization (e.g., the [EIP-712](./eip-712.md) typed message of Section 14); proof generation runs off-device in the wallet app or a delegated prover.
