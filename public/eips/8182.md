...
For deposits, the contract does not know `noteSecret`. The deposit payload therefore carries only the private fields the recipient cannot recover from the public event:
