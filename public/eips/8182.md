...
This section sketches an example auth circuit for ECDSA/secp256k1 authorization using [EIP-712](./eip-712.md) typed data signing. The companion `authVerifier` Solidity contract verifies proofs of this circuit per the Section 12 interface.
