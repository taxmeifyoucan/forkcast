...
3. If recovery succeeds, read the account code of `recovered_address` and determine whether ECDSA authority is deactivated per [EIP-7851](./eip-7851.md).
